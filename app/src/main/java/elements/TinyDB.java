...
public class TinyDB {
    ...
    public ArrayList<ImageElement> getListImage(String key, Class<ImageElement> mClass){
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<ImageElement> objects =  new ArrayList<ImageElement>();

        for(String jObjString : objStrings){
            ImageElement value  = gson.fromJson(jObjString,  mClass);
            objects.add(value);
        }
        return objects;
    }
    public void putListImage(String key, ArrayList<ImageElement> objArray){
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for(ImageElement obj : objArray){
